...
import * as AIOProduct from "./product/AIO";
import * as CaseProduct from "./product/Case";
import * as CoolerProduct from "./product/Cooler";
import * as CPUProduct from "./product/CPU";
import * as FanProduct from "./product/Fan";
import * as GPUProduct from "./product/GPU";
import * as GraphicCard from "./product/GraphicCard";
import * as HDDProduct from "./product/HDD";
import * as Mainboard from "./product/Mainboard";
import * as PSUProduct from "./product/PSU";
import * as RAMProduct from "./product/RAM";
import * as SSDProduct from "./product/SSD";
import * as CPUBlock from "./product/CPUBlock";
import * as PumpProduct from "./product/Pump";
import * as RadiatorProduct from "./product/Radiator";
