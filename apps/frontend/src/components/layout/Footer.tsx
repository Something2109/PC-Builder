    ...
    <footer className="w-full mt-auto border-t border-border bg-card/40 backdrop-blur-md py-12 px-6">
      <div className="container mx-auto grid grid-cols-1 md:grid-cols-4 gap-8">
        <div className="flex flex-col gap-3">
          <Link
            className="font-bold text-lg md:text-xl tracking-wider bg-linear-to-r from-accent-indigo via-purple-500 to-accent-cyan bg-clip-text text-transparent"
            href={"/"}
          >
            PC BUILDER
          </Link>
        ...
        <div>
          <h4 className="font-semibold text-sm uppercase tracking-wider text-accent-cyan mb-3">
            Platform
          </h4>
