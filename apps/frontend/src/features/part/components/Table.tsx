...
export const DetailTableComponent: {
  ...
  [Infos.CASE_FAN]: lazy(
    () => import("@/features/part/components/detail/CaseFanSupport")
  ),
  ...
  [Infos.EXTERNAL_PORTS]: lazy(
    () => import("@/features/part/components/detail/PartExternalPorts")
  ),
  [Infos.PSU_CONNECTOR]: lazy(
    () => import("@/features/part/components/detail/PSUConnector")
  ),
} as const;
