...
const Components: InfoComponentObject<PumpSpec.DTO> = {
  ...
  head_pressure: ({ defaultValue }) => <SuffixDisplay suffix="m">{defaultValue}</SuffixDisplay>,
  flow_rate: ({ defaultValue }) => (
    <UnitDisplay Unit={VolumeSpeedUnit} defaultUnit="L/h" defaultValue={defaultValue} />
  ),
